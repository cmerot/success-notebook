<script lang="ts" generics="T extends Record<string, unknown>, U extends FormPath<T>">
	...
	import GoalItem from './goal-control.svelte';
	...
	type FieldsetProps<T extends Record<string, unknown>, U extends FormPath<T>, M = any> = {
		 ...
		 * Should point to a GoalItemSchemaType[] field.
		 */
		name: U;
	...
	let value = fieldProxy(form.form, name) as unknown as Writable<GoalItemSchemaType[]>;
