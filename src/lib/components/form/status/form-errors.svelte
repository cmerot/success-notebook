...
<div class={cn('prose prose-sm dark:prose-invert', className)}>
	{#if $allErrors.length > 0}
		<h3>Erreur(s) dans le formulaire !</h3>
	...
	{:else}
		...
		<p>
			Le formulaire s'auto-enregistre à interval régulier, c'est très rapide et vous pouvez voir
			clignoter le témoin
